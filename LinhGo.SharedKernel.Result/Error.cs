namespace LinhGo.SharedKernel.Result;
...
public readonly record struct Error
{
    ...
    /// <summary>
    /// Creates an <see cref="Error"/> of type <see cref="ErrorType.Unauthorized"/> from a code.
    /// </summary>
    /// <param name="code">The unique error code.</param>
    public static Error WithUnauthorizedCode(string code) =>
    ...
    /// </summary>
    /// <param name="code">The unique error code.</param>
    public static Error WithNoPermissionCode(string code) =>
        new(code, ErrorType.NoPermission);
