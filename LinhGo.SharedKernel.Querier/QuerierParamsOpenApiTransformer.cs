...
/// <summary>
/// OpenAPI operation transformer to replace QuerierParams with custom query parameter descriptions
/// </summary>
public class QuerierParamsOpenApiTransformer : IOpenApiOperationTransformer
{
    public Task TransformAsync(OpenApiOperation operation, OpenApiOperationTransformerContext context, CancellationToken cancellationToken)
    {
        ...
        var hasSearchQueryParams = context.Description.ParameterDescriptions
            .Any(p => p.ParameterDescriptor.ParameterType == typeof(QuerierParams));
        ...
        {
            Name = QuerierConstants.QuerySearchKey,
        ...
        operation.Parameters.Add(new OpenApiParameter
        {
            Name = QuerierConstants.QuerySortKey,
            In = ParameterLocation.Query,
        ...
        operation.Parameters.Add(new OpenApiParameter
        {
            Name = QuerierConstants.QueryPageKey,
            In = ParameterLocation.Query,
            Description = $"Page number for pagination (default: {QuerierConstants.DefaultPageNumber})",
            Required = false,
        ...
        operation.Parameters.Add(new OpenApiParameter
        {
            Name = QuerierConstants.QueryPageSizeKey,
            In = ParameterLocation.Query,
            Description = $"Number items of each page (default: {QuerierConstants.DefaultPageSize}, min: {QuerierConstants.MinPageSize}, max: {QuerierConstants.MaxPageSize})",
            Required = false,
            Schema = new OpenApiSchema 
            { 
                Type = JsonSchemaType.Integer, 
                Minimum = QuerierConstants.MinPageSize.ToString(),
                Maximum = QuerierConstants.MaxPageSize.ToString(),
            },
        });

        operation.Parameters.Add(new OpenApiParameter
        {
            Name = QuerierConstants.QueryIncludeKey,
            In = ParameterLocation.Query,
        ...
        operation.Parameters.Add(new OpenApiParameter
        {
            Name = QuerierConstants.QueryFieldsKey,
            In = ParameterLocation.Query,
...
public class QuerierFieldsAttribute(string entityName, string[] filterFields, string[] sortFields)
    : Attribute
{
    public string[] FilterFields { get; } = filterFields;
